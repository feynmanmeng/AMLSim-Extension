...
class MLMode():
    ...
    def m1(self, info = '单收集 - 单节点 - 单分散'):
        g_name = 'm1'
        mlg = MLGraph(nid=1*1000)
        mlg.shuffle_ids()
    ...
    def m2(self, info = '单收集 - 3节点平行传递 - 单分散'):
        g_name = 'm2'
        mlg = MLGraph(nid=1*1000)
        mlg.shuffle_ids()
        mlg.new_n_to_1(name='c1_1', new_n=30, start_step=0, new_period=1, min_amount=200, max_amount=400, period=7)
        mlg.add_1_to_n(name='c1_2', lname='c1_1', n=2, period=2)
        mlg.split_components(lname='c1_2', n_accounts=[1,1], names=['c1_s1', 'c1_s2'])
        mlg.add_1_to_1(name='c1_3', lname='c1_s1', period=1)
        mlg.add_1_to_1(name='c1_4', lname='c1_3', period=1)
        mlg.add_1_to_1(name='c1_5', lname='c1_s2', period=1)
        mlg.add_1_to_1(name='c1_6', lname='c1_5', period=1)
        mlg.merge_components(name='c1_m1', lnames=['c1_4', 'c1_6'])
        mlg.add_n_to_1(name='c1_7', lname='c1_m1', period=2)
        mlg.add_1_to_n(name='c1_8', lname='c1_7', n=15, period=7)
    ...
    def m3(self, info = '单收集 - 多部图 - 单分散'):
        ...
        mlg.shuffle_ids()
        mlg.new_n_to_1(name='c1_1', new_n=30, start_step=0, new_period=1, min_amount=200, max_amount=400, period=7)
        mlg.add_1_to_n(name='c1_2', lname='c1_1', n=4, period=2)
        mlg.add_n_to_n_prob(name='c1_3', lname='c1_2', n=4, period=2, prob=0.5)
        mlg.add_n_to_n_prob(name='c1_4', lname='c1_3', n=4, period=2, prob=0.5)
        mlg.add_n_to_n_prob(name='c1_5', lname='c1_4', n=4, period=2, prob=0.5)
        mlg.add_n_to_1(name='c1_6', lname='c1_5', period=2)
        mlg.add_1_to_n(name='c1_7', lname='c1_6', n=15, period=3)
    ...
    def m5(self, info = '串联多级', g_name = 'm5', id_start = 0, id_end = 250, start_step = 1, margin_ratio=0.99, alertid=1):
        ...
        mlg.shuffle_ids()
        mlg.new_n_to_1(name='c1_1', new_n=50, start_step=start_step, new_period=1, min_amount=200, max_amount=400, period=1)
    ...
    def m6(self, info = '多路并行环形', g_name = 'm6', id_start = 0, id_end = 250, start_step = 1, margin_ratio=0.99, alertid=1):
        mlg = MLGraph(id_start, id_end, margin_ratio, alertid)
        mlg.shuffle_ids()
        mlg.new_n_to_1(name='c1_1', new_n=25, start_step=start_step, new_period=1, min_amount=200, max_amount=400, period=1)
    ...
    def m7(self, info = '树形收发', g_name = 'm7', id_start = 0, id_end = 250, start_step = 1, margin_ratio=0.99, alertid=1):
        mlg = MLGraph(id_start, id_end, margin_ratio, alertid)
        mlg.shuffle_ids()
        mlg.new_n_to_1(name='1', new_n=20, start_step=start_step, new_period=1, min_amount=200, max_amount=400, period=1)
    ...
    def m8(self, info = '混合1', g_name = 'm8', id_start = 0, id_end = 250, start_step = 1, margin_ratio=0.99, alertid=1):
        mlg = MLGraph(id_start, id_end, margin_ratio, alertid)
        mlg.shuffle_ids()
        mlg.new_n_to_1(name='s1', new_n=30, start_step=start_step, new_period=1, min_amount=200, max_amount=400, period=1)
        mlg.new_n_to_1(name='s2', new_n=30, start_step=start_step, new_period=1, min_amount=200, max_amount=400, period=1)
        mlg.new_n_to_1(name='s3', new_n=30, start_step=start_step, new_period=1, min_amount=200, max_amount=400, period=1)
        mlg.new_n_to_1(name='s4', new_n=30, start_step=start_step, new_period=1, min_amount=200, max_amount=400, period=1)
    ...
    def m5_max(self, info = '串联多级', g_name = 'm5_max', id_start = 0, id_end = 250, start_step = 1, margin_ratio=0.99, alertid=1):
        mlg = MLGraph(id_start, id_end, margin_ratio, alertid)
        mlg.shuffle_ids()
        mlg.new_n_to_1(name='c1_1', new_n=50, start_step=start_step, new_period=1, min_amount=300, max_amount=600, period=1)
        mlg.add_1_to_n(name='c1_2', lname='c1_1', n=8, period=1)
        mlg.add_n_to_1(name='c1_3', lname='c1_2', period=1)
        mlg.add_1_to_n(name='c1_4', lname='c1_3', n=8, period=1)
        mlg.add_n_to_n_prob(name='c1_5', lname='c1_4', n=6, period=1, prob=0.5)
    ...
    def m6_max(self, info = '多路并行环形', g_name = 'm6_max', id_start = 0, id_end = 250, start_step = 1, margin_ratio=0.99, alertid=1):
        mlg = MLGraph(id_start, id_end, margin_ratio, alertid)
        mlg.shuffle_ids()
        mlg.new_n_to_1(name='c1_1', new_n=50, start_step=start_step, new_period=1, min_amount=300, max_amount=600, period=1)
        mlg.add_1_to_n(name='c1_2', lname='c1_1', n=4, period=1)
    ...
    def m7_max(self, info = '树形收发', g_name = 'm7_max', id_start = 0, id_end = 250, start_step = 1, margin_ratio=0.99, alertid=1):
        mlg = MLGraph(id_start, id_end, margin_ratio, alertid)
        mlg.shuffle_ids()
        mlg.new_n_to_1(name='1', new_n=20, start_step=start_step, new_period=1, min_amount=300, max_amount=600, period=1)
    ...
    def m8_max(self, info = '混合1', g_name = 'm8_max', id_start = 0, id_end = 250, start_step = 1, margin_ratio=0.99, alertid=1):
        mlg = MLGraph(id_start, id_end, margin_ratio, alertid)
        mlg.shuffle_ids()
        mlg.new_n_to_1(name='s1', new_n=30, start_step=start_step, new_period=1, min_amount=300, max_amount=600, period=1)
        mlg.new_n_to_1(name='s2', new_n=30, start_step=start_step, new_period=1, min_amount=300, max_amount=600, period=1)
        mlg.new_n_to_1(name='s3', new_n=30, start_step=start_step, new_period=1, min_amount=300, max_amount=600, period=1)
        mlg.new_n_to_1(name='s4', new_n=30, start_step=start_step, new_period=1, min_amount=300, max_amount=600, period=1)
        mlg.merge_components(name='m7', lnames=['s1', 's2'])
        mlg.add_n_to_1(name='s5', lname='m7', period=1)
        mlg.merge_components(name='m8', lnames=['s3', 's4'])
        mlg.add_n_to_1(name='s6', lname='m8', period=1)
